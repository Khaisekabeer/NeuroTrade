...
"[project]/src/app/api/symbols/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        symbols: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TRADE_SYMBOLS"]
    });
}
async function POST(req) {
    ...
    if (!symbol || !symbol.includes('/')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: 'symbol must be like "AVAX/USDT"'
        }, {
            status: 400
        });
    }
    ...
    if (action === 'remove') {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$trading$2d$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["manualClose"])(symbol);
        } catch (e) {
            console.warn(`[symbols] close position failed for ${symbol}:`, e?.message);
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["removeSymbol"])(symbol);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$trading$2d$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifySymbolRemoved"])(symbol);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].tradingSymbol.deleteMany({
            where: {
                symbol
            }
        }).catch(()=>{});
    ...
    if (action === 'add') {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TRADE_SYMBOLS"].find((s)=>s.symbol === symbol)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: `${symbol} is already in the list`
            }, {
                status: 400
            });
        }
        try {
            let price = 0;
            const spotTicks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bitget$2d$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchLiveTickers"])([
                symbol
            ], 'spot');
            if (spotTicks.length > 0) {
                price = spotTicks[0].price;
            } else {
                const futTicks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bitget$2d$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchLiveTickers"])([
                    symbol
                ], 'futures');
                if (futTicks.length === 0) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        ok: false,
                        error: `${symbol} not found on Bitget spot or futures`
                    }, {
                        status: 400
                    });
                }
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addSymbol"])({
                symbol,
                name: base,
                base,
                price,
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$trading$2d$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["seedNewSymbol"])(symbol, price);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].tradingSymbol.upsert({
                where: {
                    symbol
                },
                create: {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: true,
                symbols: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TRADE_SYMBOLS"],
                message: `Added ${symbol} at $${price}`
            });
        } catch (e) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: `Failed to verify ${symbol}: ${e?.message}`
            }, {
                status: 502
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7251b3fb._.js.map